...
async function renderFrame()
{
    ...
    {
        const rayAngle = (gameState.playerA - fov / 2.0) + (x / screen.width) * fov;
        ...
        while (!hitWall && distanceToWall < depth)
        {
            ...
            else if (firstRoom.map[testY * firstRoom.mapWidth + testX] > 0)
            {
                ...
                const testPointX = gameState.playerX + eyeX * distanceToWall;
                const testPointY = gameState.playerY + eyeY * distanceToWall;
